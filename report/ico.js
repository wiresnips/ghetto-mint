...
( function( exports ) {
  ...
  Ico.Base = Ico.Class.create( {
    ...
    format_value: function( v, p1000 ) {
      if ( false && v != 0 && typeof p1000 !== "number" ) { // !! v can be the string "0"
    ...
    show_label_onmouseover : function( o, value, attr, serie, i, name ) {
        ...
        o.node.onmouseover = function() {
          ...
          if (t.options.mouseover_attributes.callback)
            t.options.mouseover_attributes.callback( label )
  ...
  */
  ...
  Ico.Component.Labels = Ico.Class.create( Ico.Component, {
    ...
    draw_labels_grid: function( d, o ) {
      ...
      for ( var i = -1, l = t.labels.length; ++i < l; ) {
        ...
        var skipMarker = (label.attrs.text.length == 0);
        var emphasize = grid && grid.emphasize && grid.emphasize.indexOf(label.attrs.text) != -1

        marker && !skipMarker && path.push( 'M', x, y, marker );
        emphasize && path.push("M", x, y, grid_len )
  ...
  Ico.Component.ValueLabels = Ico.Class.create( Ico.Component.Labels, {
    calculate: function( o, p ) {
      ...
      var p1000 = Ico.root( params.step * params.spaces, 1000 ) && false;
      if ( p1000 ) {
